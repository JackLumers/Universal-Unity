...
namespace Common.Helpers.Pooling.SimplePool
{
    ...
    /// If you use same types in different ways, consider to use pooling with specifying pool name.
    ///
    /// </summary>
    ///
    /// <example>
    ...
    ///
    /// <para>
    /// 3. Return object in pool by calling <see cref="Return"/> when you are don't need this object right now.
    /// </para>
    ///
    /// <para>
    ...
    public static class SimplePool
    {
        ...
        /// </exception>
        public static T Get<T>([NotNull] T original, [NotNull] Transform parent, [NotNull] string poolName)
        ...
        /// </exception>
        public static void CreatePool([NotNull] string poolName)
        {
            if (!ObjectsDictionary.ContainsKey(poolName))
            {
